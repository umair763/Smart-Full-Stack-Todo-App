...
function Subtask({ subtask, onDelete, onUpdate, onStatusChange }) {
   ...
   return (
      <>
         ...
         <div className={`mt-5 sm:hidden p-3 sm:p-4 rounded-lg border-l-4 ${getPriorityColorClass()}`}>
         ...
         <div
            className={`mt-6 hidden sm:grid grid-cols-[24px,1fr,auto] w-full px-3 sm:px-4 py-3 sm:py-3.5 rounded-lg border-l-4 ${getPriorityColorClass()} items-center gap-3 sm:gap-4`}
         >
            {/* Priority Radio Button */}
            <input
               type="radio"
