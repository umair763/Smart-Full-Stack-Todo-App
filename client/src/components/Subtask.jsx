         ...
         <div className="flex items-center gap-2 flex-shrink-0 text-sm text-gray-600 ">
            ...
            <div className="flex items-center gap-1 ml-auto">
               ...
               <button
                  ...
                  className="p-1 rounded-full text-blue-600 hover:bg-blue-100/70 transition-colors"
               >
               ...
               <button
                  ...
                  className="p-1 rounded-full text-red-600 hover:bg-red-100/70 transition-colors"
               >
               ...
               <button
                  ...
                  className={`w-5 h-5 flex items-center justify-center rounded-full border-2 transition-colors ${
                     completed ? 'bg-green-600 border-green-600 text-white' : 'border-gray-400 hover:border-green-600'
                  }`}
               >
