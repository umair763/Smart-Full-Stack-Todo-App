...
const DeleteSubtaskModal = ({ isOpen, onClose, onConfirm, isDeleting, subtaskTitle }) => {
         ...
         >
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
               <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 font-proza">Delete Subtask</h3>
               </div>
               {!isDeleting && (
                  <button
                     onClick={handleClose}
               ...
               <div className="mb-6">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                     <p className="text-red-800 text-sm font-medium mb-2">
                        You are about to delete the following subtask:
                     </p>
                     <div className="bg-white border border-red-200 rounded p-3">
                        <p className="text-gray-900 font-semibold">"{subtaskTitle}"</p>
                     </div>
                  </div>
                  <p className="text-gray-600 text-sm">
                     This action cannot be undone. The subtask will be permanently removed from your task.
                  </p>
               </div>
