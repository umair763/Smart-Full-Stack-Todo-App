...
const PrivacyPolicy = () => (
   <div className="w-11/12 max-w-6xl p-8 mt-6 mx-auto bg-white dark:bg-gray-300/80 flex flex-col overflow-hidden rounded-xl">
      <div className="mx-auto text-slate-800">
         <h1 className="text-3xl font-bold mb-4 text-center">Privacy Policy</h1>
         <p className="text-justify mb-4">Last updated: July 01, 2025</p>
         ...
         <h2 className="text-2xl font-semibold mt-8 mb-2 text-left">Interpretation and Definitions</h2>
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Interpretation</h3>
         <p className="text-justify mb-4">
            The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.
         </p>
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Definitions</h3>
         <p className="text-justify mb-4">For the purposes of this Privacy Policy:</p>
         ...
         <h2 className="text-2xl font-semibold mt-8 mb-2 text-left">Collecting and Using Your Personal Data</h2>
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Types of Data Collected</h3>
         <h4 className="text-lg font-semibold mt-4 mb-2 text-left">Personal Data</h4>
         <p className="text-justify mb-4">
         ...
         <h4 className="text-lg font-semibold mt-4 mb-2 text-left">Usage Data</h4>
         <p className="text-justify mb-4">Usage Data is collected automatically when using the Service.</p>
         <p className="text-justify mb-4">
         ...
         <h4 className="text-lg font-semibold mt-4 mb-2 text-left">Tracking Technologies and Cookies</h4>
         <p className="text-justify mb-4">
         ...
         <p className="text-justify mb-4">We use both Session and Persistent Cookies for the purposes set out below:</p>
         ...
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Use of Your Personal Data</h3>
         <p className="text-justify mb-4">The Company may use Personal Data for the following purposes:</p>
         <ul className="list-disc pl-6 space-y-2 text-justify">
            <li>
         ...
         <p className="text-justify mb-4">We may share Your personal information in the following situations:</p>
         <ul className="list-disc pl-6 space-y-2 text-justify">
            <li>
         ...
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Retention of Your Personal Data</h3>
         <p className="text-justify mb-4">
         ...
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Transfer of Your Personal Data</h3>
         <p className="text-justify mb-4">
         ...
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Delete Your Personal Data</h3>
         <p className="text-justify mb-4">
         ...
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Disclosure of Your Personal Data</h3>
         <h4 className="text-lg font-semibold mt-4 mb-2 text-left">Business Transactions</h4>
         <p className="text-justify mb-4">
         ...
         <h4 className="text-lg font-semibold mt-4 mb-2 text-left">Law enforcement</h4>
         <p className="text-justify mb-4">
         ...
         <h4 className="text-lg font-semibold mt-4 mb-2 text-left">Other legal requirements</h4>
         <p className="text-justify mb-4">
         ...
         <h3 className="text-xl font-semibold mt-6 mb-2 text-left">Security of Your Personal Data</h3>
         <p className="text-justify mb-4">
         ...
         <h2 className="text-2xl font-semibold mt-8 mb-2 text-left">Children's Privacy</h2>
         <p className="text-justify mb-4">
         ...
         <h2 className="text-2xl font-semibold mt-8 mb-2 text-left">Links to Other Websites</h2>
         <p className="text-justify mb-4">
         ...
         <h2 className="text-2xl font-semibold mt-8 mb-2 text-left">Changes to this Privacy Policy</h2>
         <p className="text-justify mb-4">
         ...
         <h2 className="text-2xl font-semibold mt-8 mb-2 text-left">Contact Us</h2>
         <p className="text-justify mb-4">If you have any questions about this Privacy Policy, You can contact us:</p>
         <ul className="list-disc pl-6 space-y-2 text-justify">
            <li>
               By email:{' '}
               <a href="mailto:muhammadumairkhan945@gmail.com" className="text-blue-600 underline">
