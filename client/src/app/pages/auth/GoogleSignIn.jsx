   ...
   return (
      <div className="w-full">
         ...
         <div className="w-full">
            ...
            {/* Fallback button when Google script doesn't load */}
            {!isScriptLoaded && (
               <button
                  onClick={handleFallbackGoogleSignIn}
                  className="w-full h-11 bg-white border border-gray-300 rounded-lg flex items-center justify-center space-x-3 hover:bg-gray-50 transition-colors"
               >
