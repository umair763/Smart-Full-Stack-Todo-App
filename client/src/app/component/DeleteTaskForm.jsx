   ...
   return (
      ...
      >
         <div className="grid grid-cols-2 gap-1 items-center">
            ...
            <select
               className="bg-[#EB5D41] rounded-lg text-gray-900 text-sm xs:pl-1 sm:pl-1 md:pl-1 p-2"
         ...
         <div className="flex justify-between mt-2">
            <button
               type="submit"
               className="bg-gradient-to-br from-red-500 to-red-700 text-white font-medium py-1 rounded-lg shadow hover:shadow-md transition duration-300 w-full mr-1"
            >
               Confirm
            </button>
            <button
