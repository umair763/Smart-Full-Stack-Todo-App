...
const Header = () => {
   ...
   return (
      <header className="bg-gradient-to-r -mt-16 from-purple-600 via-blue-600 to-indigo-700 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 text-white rounded-xl shadow-lg border border-white/20 dark:border-white/10 backdrop-blur-sm">
